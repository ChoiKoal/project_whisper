...
SANCTUM_LEGEND = {
    ...
    "objects": {
        ...
        "h": {"kind": "l2obj", "l2_id": "data_crystal", "art": "l2s_data_crystal", "art_variants": ["l2s_data_crystal_b", "l2s_data_crystal_c"], "offset": [0, -16], "blocks": False, "glow": "cyan", "glow_scale": 0.5, "gatherable": {"item_id": "J8"}, "_note": "데이터 결정"},
        "k": {"kind": "l2obj", "l2_id": "corroded_core", "art": "l2s_corroded_core", "art_variants": ["l2s_corroded_core_b", "l2s_corroded_core_c"], "offset": [0, -14], "blocks": False, "gatherable": {"item_id": "J9"}, "_note": "부식 코어"},
        "o": {"kind": "l2obj", "l2_id": "fiber_bundle", "art": "l2s_fiber_bundle", "art_variants": ["l2s_fiber_bundle_b", "l2s_fiber_bundle_c"], "offset": [0, -14], "blocks": False, "gatherable": {"item_id": "J10"}, "_note": "광섬유 다발"},
        "b": {"kind": "l2obj", "l2_id": "coolant_gel", "art": "l2s_coolant_gel", "art_variants": ["l2s_coolant_gel_b", "l2s_coolant_gel_c"], "offset": [0, -12], "blocks": False, "glow": "cyan", "glow_scale": 0.4, "gatherable": {"item_id": "J11"}, "_note": "냉각 젤"},
    },
